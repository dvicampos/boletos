...
class Pago(db.Model):
    ...
    abonado = db.Column(db.Float)  # Lo que pagó en este momento
    confirmado = db.Column(db.Boolean, default=False)

    # NUEVO para pagos en parcialidades
    tipo_pago = db.Column(db.String(20))  # contado, mensual, semanal
    parcialidad = db.Column(db.String(50))  # Ej: '1 de 4', '2 de 3'
    notas = db.Column(db.Text)  # Ej: "Cliente pagó con transferencia"
...
#     plan_pago = db.Column(db.String(10))  # 'semanal' o 'quincenal'
#     estado = db.Column(db.String(20), default='vigente')  # o 'cancelado'
...
#     asientos = db.Column(db.String(200))
#     imagen_asientos = db.Column(db.String(255))
#     precios_por_zona = db.Column(db.Text)

# class Pago(db.Model):
#     id = db.Column(db.Integer, primary_key=True)
#     usuario_id = db.Column(db.Integer, db.ForeignKey('usuario.id'))
#     evento_id = db.Column(db.Integer, db.ForeignKey('evento.id'))  # ← agrégalo si no existe
#     asiento = db.Column(db.String(50))  # ← agrégalo si no existe
